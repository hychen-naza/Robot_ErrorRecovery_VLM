...
def run_callee(prompt_configuration,loggin_dict, log_save_dir, connection_kwargs, max_steps=10, num_seeds=1, fake_marker_type=None, rows=1, cols=1, rotation_type=None, width=640, height=480):
    ...
    def save_logs(seed, step, log_save_dir, hor_raw_msg, summarized_hor_action, ver_raw_msg, summarized_ver_action, combined_action, current_image, coverage):
        # logging 
    ...
    for seed in range(4):
        ...
        for step in range(max_steps):
            ...
            # print(f"current_image {current_image.shape}")
            # pdb.set_trace()
            cv2.rectangle(current_image, (after_box.cx-15, after_box.cy-5), (after_box.cx+15, after_box.cy+5), (255, 0, 0), -1) # fill 
            ...
            #     step = max_steps-1
            #     hor_action = 0
            print(f"Horizontal action: {hor_action}, Vertical action: {ver_action}")
            ...
            coverage = 0
            save_logs(seed, step, log_save_dir, hor_raw_msg, summarized_hor_action, ver_raw_msg, summarized_ver_action, combined_action, current_image, coverage)
            ...
            if step == max_steps-1:
                ...
                save_logs(seed, step+1, log_save_dir, hor_raw_msg, summarized_hor_action, ver_raw_msg, summarized_ver_action, combined_action, after_image, coverage)
...
if __name__ == "__main__": 
    ...
    parser.add_argument("-pt","--prompt_type", type=str, default="combine_grasp_prompt")
